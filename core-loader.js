...
const modules=['src/model.js?v=2','src/timer-core-v1.js?v=6','src/timer-math-v1.js?v=5','src/input.js?v=2','src/timer-view.js?v=1','src/abyss-dashboard.js?v=2','src/game-panels.js?v=1','src/persistence-v1.js?v=5','src/engine.js?v=2','src/actions.js?v=1','src/daily-weekly-v1.js?v=5','src/games-loader-v1.js?v=5'];
