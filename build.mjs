...
let esbuild = process.env.ESBUILD_BIN || 'esbuild';
if (!process.env.ESBUILD_BIN) {
  try { esbuild = require.resolve('esbuild/bin/esbuild'); } catch (_) {}
}
...
js('dist/app.min.js',['src/chrono-core.js','src/core.js','src/chrono-compat.js','src/dotabyss.js','src/bootstrap.js']);
